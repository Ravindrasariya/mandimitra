...
const translations: Record<string, Record<Language, string>> = {
  ...
  "dash.totalVehicleBhada": { en: "Total Vehicle Bhada", hi: "कुल गाड़ी भाड़ा" },
  ...
  "cash.due": { en: "Due", hi: "बकाया" },
  "cash.bhadaCard": { en: "Bhada card", hi: "भाड़ा कार्ड" },
  "cash.bhadaPending": { en: "Pending Freight/Bhada", hi: "बकाया भाड़ा" },
  "cash.searchBhadaPending": { en: "Search farmer or stock date...", hi: "किसान या स्टॉक तारीख खोजें..." },
  "cash.noBhadaPending": { en: "No pending Freight/Bhada", hi: "कोई बकाया भाड़ा नहीं" },
  "cash.selectBhadaEntry": { en: "Select a pending Freight/Bhada entry to pay against", hi: "भुगतान के लिए एक बकाया भाड़ा प्रविष्टि चुनें" },
  "cash.bhadaAmountExceedsDue": { en: "Amount is more than the pending Freight/Bhada (₹{due})", hi: "राशि बकाया भाड़ा (₹{due}) से अधिक है" },
  "cash.of": { en: "of", hi: "में से" },
  ...
  "buyerLedger.noArchived": { en: "No archived buyers", hi: "कोई अभिलेखित खरीदार नहीं" },
  "buyerLedger.downloadOrShare": { en: "Download or share", hi: "डाउनलोड करें या भेजें" },
  "buyerLedger.downloadPaana": { en: "Download", hi: "डाउनलोड करें" },
  "buyerLedger.shareWhatsapp": { en: "Share on WhatsApp", hi: "व्हाट्सएप पर भेजें" },
  "buyerLedger.archive": { en: "Archive", hi: "अभिलेख" },
  "buyerLedger.reinstate": { en: "Reinstate", hi: "बहाल करें" },
  "buyerLedger.showArchived": { en: "Show Archived", hi: "अभिलेख दिखाएं" },
  ...
  "buyerLedger.totalAdvance": { en: "Total Advance", hi: "कुल अग्रिम" },
  ...
  "stock.bhadaLabel": { en: "Freight/Bhada", hi: "भाड़ा" },
  "stock.bhadaPaid": { en: "Paid", hi: "भुगतान हो गया" },
  "stock.bhadaPartial": { en: "Partly paid", hi: "आंशिक भुगतान" },
  ...
  "stock.farmerPay": { en: "Farmer Pay", hi: "किसान भुगतान" },
  "stock.farmerPayNoDue": { en: "Nothing due to the farmer for this bill", hi: "इस बिल पर किसान को कोई बकाया नहीं है" },
  "stock.farmerPaySaveFirst": { en: "Save this entry before paying the farmer", hi: "किसान को भुगतान करने से पहले यह प्रविष्टि सहेजें" },
  ...
  "stock.bhadaPay": { en: "Freight/Bhada Pay", hi: "भाड़ा भुगतान" },
  "stock.bhadaPayEnterAmount": { en: "Enter an amount", hi: "राशि दर्ज करें" },
  ...
  "stock.totalVehicleBhada": { en: "Total Vehicle Bhada", hi: "कुल गाड़ी भाड़ा" },
  ...
  "stock.failedDeleteLot": { en: "Failed to delete lot", hi: "लॉट हटाने में विफल" },
  ...
  "guard.bhadaCardIdentity": { en: "Cannot change the farmer or the stock date on this card — ₹{paid} of Freight/Bhada has already been paid against it. Reverse that payment on the Cash page first.", hi: "इस कार्ड का किसान या स्टॉक तारीख नहीं बदल सकते — इसके विरुद्ध ₹{paid} भाड़ा भुगतान पहले ही हो चुका है। पहले नकद पेज पर वह भुगतान वापस करें।" },
  "guard.bhadaLotBlocked": { en: "Cannot archive or delete this — ₹{paid} of Freight/Bhada has already been paid against this farmer card. Reverse that payment on the Cash page first.", hi: "इसे अभिलेखित या हटा नहीं सकते — इस किसान कार्ड के विरुद्ध ₹{paid} भाड़ा भुगतान पहले ही हो चुका है। पहले नकद पेज पर वह भुगतान वापस करें।" },
  "guard.bhadaRateCut": { en: "Cannot reduce Vehicle Bhada below ₹{paid} — that much Freight/Bhada has already been paid against this card. Reverse that payment on the Cash page first.", hi: "वाहन भाड़ा ₹{paid} से कम नहीं कर सकते — इस कार्ड के विरुद्ध इतना भाड़ा भुगतान पहले ही हो चुका है। पहले नकद पेज पर वह भुगतान वापस करें।" },
  "guard.archiveLot": { en: "Cannot archive this lot — {parties} against it. {how}", hi: "इस लॉट को अभिलेखित नहीं कर सकते — इसके विरुद्ध {parties}। {how}" },
  "guard.archiveLots": { en: "Cannot archive these lots — {parties} against them. {how}", hi: "इन लॉट को अभिलेखित नहीं कर सकते — इनके विरुद्ध {parties}। {how}" },
  "guard.archiveFarmer": { en: "Cannot archive this farmer — {parties} against their lots. {how}", hi: "इस किसान को अभिलेखित नहीं कर सकते — इनके लॉट के विरुद्ध {parties}। {how}" },
  "guard.deleteBid": { en: "Cannot delete this bid — {parties} against it. {how}", hi: "इस बोली को नहीं हटा सकते — इसके विरुद्ध {parties}। {how}" },
  "guard.deleteLot": { en: "Cannot delete this lot — {parties} against its transactions. {how}", hi: "इस लॉट को नहीं हटा सकते — इसके लेनदेन के विरुद्ध {parties}। {how}" },
  "guard.paymentBlocked": { en: "Cannot complete this action — an active payment exists. Please reverse all payments first.", hi: "यह कार्रवाई पूरी नहीं कर सकते — सक्रिय भुगतान मौजूद है। पहले सभी भुगतान वापस करें।" },
