...
- Tables: businesses, users, farmers, buyers, buyer_edit_history, lots, bids, transactions, cash_entries
...
- Transaction fields: includes hammaliPerBag (per-bag rate), hammaliCharges (total = perBag × bags), chargedTo (Buyer/Seller)
